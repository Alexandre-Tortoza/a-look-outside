...
def treinar(config_override: Optional[dict] = None) -> HistoricoTreino:
    params = {
        ...
        "seed": cfg.SEED, "pretrained": cfg.PRETRAINED, "backbone": cfg.BACKBONE,
    ...
    log = obter_logger(__name__, arquivo_log=Path("docs/vit/treino.log"))
    ...
    rede = ViTGalaxy(backbone=params["backbone"], pretrained=params["pretrained"]).construir(
